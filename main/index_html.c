...
"    <section class='card'>\n"
"      <h2>Servo</h2>\n"
"      <p class='muted'>Controle independente do terceiro atuador. Ajuste o ângulo entre 0° e 180°, com padrão inicial em 90°.</p>\n"
"      <div class='grid'>\n"
"        <label>Angle (deg)\n"
"          <input id='servo_angle' type='number' min='0' max='180' step='1' value='90'>\n"
"        </label>\n"
"      </div>\n"
"      <div class='row' style='margin-top:12px'>\n"
"        <button class='primary' onclick='moveServo()'>Move servo</button>\n"
...
"        <span class='pill'>Servo ${state.servo.enabled ? 'ON' : 'IDLE'}</span>\n"
"        <span class='pill'>Servo ${state.servo.angle}°</span>\n"
"        <span class='pill'>Servo GPIO ${state.servo.gpio}</span>\n"
...
"    }\n"
"\n"
"    function applyServoState(state) {\n"
"      if (!state) return;\n"
"      syncField('servo_angle', state.angle);\n"
"    }\n"
"\n"
"    async function moveServo() {\n"
"      const angle = parseInt(document.getElementById('servo_angle').value, 10);\n"
"      await api('/api/servo', { angle });\n"
"      clearDirtyFields();\n"
"      await refreshState();\n"
"    }\n"
"\n"
"    async function setServoPreset(angle) {\n"
"      const input = document.getElementById('servo_angle');\n"
"      input.value = angle;\n"
